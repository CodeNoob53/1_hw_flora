...
Усі товари та відгуки лежать у `db.json` (24 букети, 10 відгуків). Це єдине джерело даних: `json-server` віддає його локально, а збірка для GitHub Pages розкладає кожну колекцію в окремий статичний файл (`dist/api/products.json`, `dist/api/feedbacks.json`).
